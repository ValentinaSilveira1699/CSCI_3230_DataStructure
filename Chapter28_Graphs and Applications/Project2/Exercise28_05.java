...
public class Exercise28_05 {
    ...
    public Exercise28_05() throws Exception {
        ...
        if (list != null) {
            ...
            System.out.println("There is no path between the cities.");
        }
    }
    ...
    class UnweightedGraphWithGetPath<V> extends UnweightedGraph<V> {
        ...
        public List<Integer> getPath(int u, int v) {
            ...
            while (!queue.isEmpty()) {
                ...
                for (Edge edge : neighbors.get(currentVertex)) {
                    int neighbor = edge.v;
                    if (!visited[neighbor]) {
            ...
            Collections.reverse(path); // Reverse the list to get the path from u to v
    ...
    class UnweightedGraph<V> implements Graph<V> {
        ...
        protected UnweightedGraph(List<Edge> edges, int numberOfVertices) {
            for (int i = 0; i < numberOfVertices; i++) {
                addVertex((V)(Integer.valueOf(i))); // Use Integer.valueOf(i) instead of (V)(new Integer(i))
            }
