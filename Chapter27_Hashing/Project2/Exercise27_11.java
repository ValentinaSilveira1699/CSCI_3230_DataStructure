/*
(Implement set operations in MyHashSet)
The implementations of the methods addAll, removeAll, retainAll, toArray(), and toArray(T[]) are omitted in the MyHashSet class. 
Use the template at https://liveexample.pearsoncmg.com/test/Exercise27_11.txt to implement these methods. Also add a new constructor MyHashSet(E[] list) in the MyHashSet class.
*/
